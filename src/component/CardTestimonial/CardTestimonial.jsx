...
export default function CardTestimonial({cardtesttext , name , work , imgtest , icon1 , icon2 , display}) {
  return (
    <>
    <Card style={{ width: '360px' , height : '400px'}} className= {` border-0 Card-Testimotial ${display}`}>
      <Card.Body>
